...
VPATH = ./src
PKG_TCL_SOURCES =  tcl/tclmcairo-0.3.6.tm tcl/canvas2cairo-0.1.tm tcl/shape_renderer-0.1.tm tcl/svg2cairo-0.1.tm
PKG_HEADERS  = 
...
test-canvas2cairo: all
	TCLMCAIRO_LIBDIR=. $(TCLSH) tests/test-canvas2cairo.tcl

test-svg2cairo: all
	TCLMCAIRO_LIBDIR=. $(TCLSH) tests/test-svg2cairo.tcl

test-all: test test-canvas2cairo test-svg2cairo
