...
powershell -Command "(Get-Content pkgIndex.tcl.in) -replace '@PACKAGE_NAME@','tclmcairo' -replace '@PACKAGE_VERSION@','0.3.1' | Set-Content pkgIndex.tcl"
